...
```bash
printf '%s\n' '{"edits":[{"op":"replace","pos":"12#NK","end_pos":"18#VR","lines":["new block"]},{"op":"insert","pos":"22#VR","after":true,"lines":["// inserted"]}]}' | hledit batch main.go
...
```json
{
  ...
  "editsApplied": 2,
  "updatedAnchors": {
    "lines": [{"line":2,"anchor":"2#AB","text":"updated"}],
    "offset": 2,
    "limit": 1,
    "desiredLimit": 1,
    "truncated": false
